#!/usr/bin/env python3
"""
Simple script to check what values are actually being used in the notebook
This will help us debug the quotient constraint failure
"""

print("=" * 70)
print("NOTEBOOK VALUES CHECKER")
print("=" * 70)

print("""
This script needs to be run from within the Jupyter notebook environment
to access the actual values being used.

To use this debug script:

1. In the notebook, after running cells 91-96 and 98, add a new cell with:

%run sageless/solutions/debug/verify_plonk/check_notebook_values_inline.py

2. This will print all the critical values and help identify the quotient
   constraint failure.

Alternatively, copy the following code into a new notebook cell:
""")

inline_code = """
# === PASTE THIS INTO A NOTEBOOK CELL AFTER RUNNING CELLS 91-98 ===
